...
import 'socio_economico_model.dart';
export 'socio_economico_model.dart';

class SocioEconomicoWidget extends StatefulWidget {
  const SocioEconomicoWidget({Key? key}) : super(key: key);

  @override
  _SocioEconomicoWidgetState createState() => _SocioEconomicoWidgetState();
}

class _SocioEconomicoWidgetState extends State<SocioEconomicoWidget> {
  late SocioEconomicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SocioEconomicoModel());
                                    ...
                                    child: Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium,
                                        validator: _model
                                            .nomeCompletoControllerValidator
                                            .asValidator(context),
                                      ),
                                    ),
                                  ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  FlutterFlowDropDown<String>(
                                    ...
                                    hintText: 'Selecione o Local de Votação...',
                                    icon: Icon(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FlutterFlowDropDown<String>(
                                    ...
                                    onChanged: (val) =>
                                        setState(() => _model.idadeValue = val),
                                    width: 349.0,
                                    height: 50.0,
                                    textStyle:
                                        FlutterFlowTheme.of(context).bodyMedium,
                                    hintText: 'Selecione a idade...',
                                    icon: Icon(
                                      Icons.keyboard_arrow_down_rounded,
                                      color: FlutterFlowTheme.of(context)
                                          .secondaryText,
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FlutterFlowDropDown<String>(
                                    controller:
                                        _model.escolaridadeValueController ??=
                                            FormFieldController<String>(null),
                                    options: [
                                      'Até 1º  Grau Incompleto',
                                      '1º Grau Completo a 2º Grau Incompleto',
                                      '2º Grau Completo ',
                                      'Superior Imcompleto',
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FlutterFlowDropDown<String>(
                                    controller:
                                        _model.rendaFamiliarValueController ??=
                                            FormFieldController<String>(null),
                                    options: [
                                      'Até R\$ 1.320,00',
                                      'de 1.320,00 à R\$ 2.640,00',
                                      'de R\$ 2.640,00 à R\$ 6.600,00',
                                      'Acima de R\$ 6.600,00 ',
                                      'Não Respondeu'
                                    ],
                                    onChanged: (val) => setState(
                                        () => _model.rendaFamiliarValue = val),
                                    width: 349.0,
                                    height: 50.0,
                                    textStyle:
                                        FlutterFlowTheme.of(context).bodyMedium,
