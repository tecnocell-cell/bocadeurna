...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Logar',
          path: '/logar',
          builder: (context, params) => LogarWidget(),
        ),
        FFRoute(
          name: 'Registro',
          path: '/registro',
        ...
        FFRoute(
          name: 'satisfacao',
          path: '/satisfacao',
          builder: (context, params) => SatisfacaoWidget(),
        ),
        FFRoute(
          name: 'satisfacao2',
          path: '/satisfacao2',
          builder: (context, params) => Satisfacao2Widget(),
        ),
        FFRoute(
          name: 'satisfacao3',
          path: '/satisfacao3',
          builder: (context, params) => Satisfacao3Widget(),
        ),
        FFRoute(
          name: 'socioEconomico',
          path: '/socioEconomico',
          builder: (context, params) => SocioEconomicoWidget(),
        ),
        FFRoute(
          name: 'estimuladaPrefeito',
          path: '/estimuladaPrefeito',
